...
func _1565341329_initial_schemaDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1565341329_initial_schema.down.sql", size: 24, mode: os.FileMode(0644), modTime: time.Unix(1693317681, 0)}
...
func _1565341329_initial_schemaUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1565341329_initial_schema.up.sql", size: 294, mode: os.FileMode(0644), modTime: time.Unix(1693317681, 0)}
